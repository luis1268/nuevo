...
class ChocolatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chocolate" do
    assert_difference('Chocolate.count') do
      post chocolates_url, params: { chocolate: { apellido: @chocolate.apellido, edad: @chocolate.edad, email: @chocolate.email, name: @chocolate.name } }
    end
  ...
  test "should update chocolate" do
    patch chocolate_url(@chocolate), params: { chocolate: { apellido: @chocolate.apellido, edad: @chocolate.edad, email: @chocolate.email, name: @chocolate.name } }
