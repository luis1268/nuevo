...
class PerrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perro" do
    assert_difference('Perro.count') do
      post perros_url, params: { perro: { apellido: @perro.apellido, edad: @perro.edad, email: @perro.email, name: @perro.name } }
    end
  ...
  test "should update perro" do
    patch perro_url(@perro), params: { perro: { apellido: @perro.apellido, edad: @perro.edad, email: @perro.email, name: @perro.name } }
